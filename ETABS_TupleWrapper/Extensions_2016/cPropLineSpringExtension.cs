...
namespace ETABS2016
{
    ...
    {
		public static (double U1, double U2, double U3, double R1, int NonlinearOption2, int NonlinearOption3, int color, string notes, string iGUID) GetLineSpringProp(this cPropLineSpring obj, string Name) {
			double U1, U2, U3, R1;
		...
		public static (int NumberNames, string[] MyName) GetNameList(this cPropLineSpring obj) {
			int NumberNames;
