...
namespace ETABS2016
{
    ...
    {
		public static string GetCode(this cDesignSteel obj) {
			string CodeName;
			CodeName = default(string);
		    var res = obj.GetCode(ref CodeName);
		    return CodeName;
		}
		public static (int NumberItems, string[] MyName) GetComboDeflection(this cDesignSteel obj) {
			int NumberItems;
		...
		public static (int NumberItems, string[] MyName) GetComboStrength(this cDesignSteel obj) {
			int NumberItems;
			NumberItems = default(int);
			string[] MyName;
			MyName = default(string[]);
		...
		public static string GetDesignSection(this cDesignSteel obj, string Name) {
			string PropName;
			PropName = default(string);
		    var res = obj.GetDesignSection(Name, ref PropName);
		    return PropName;
		}
		public static (int NumberItems, string[] MyName) GetGroup(this cDesignSteel obj) {
			int NumberItems;
			NumberItems = default(int);
			string[] MyName;
			MyName = default(string[]);
		...
		public static (int NumberItems, string[] FrameName, double[] Ratio, int[] RatioType, double[] Location, string[] ComboName, string[] ErrorSummary, string[] WarningSummary) GetSummaryResults(this cDesignSteel obj, string Name, eItemType ItemType) {
			int NumberItems;
			NumberItems = default(int);
		...
		public static (int NumberItems, string[] LoadCase, string[] Point, double[] Displ, bool Active) GetTargetDispl(this cDesignSteel obj) {
			int NumberItems;
			NumberItems = default(int);
		...
		public static (int NumberItems, string ModalCase, int[] Mode, double[] Period, bool Active) GetTargetPeriod(this cDesignSteel obj) {
			int NumberItems;
			NumberItems = default(int);
			string ModalCase;
		...
		public static (int NumberItems, int N1, int N2, string[] MyName) VerifyPassed(this cDesignSteel obj) {
		...
		public static (int NumberItems, string[] MyName) VerifySections(this cDesignSteel obj) {
			int NumberItems;
			NumberItems = default(int);
			string[] MyName;
			MyName = default(string[]);
		...
		public static (int NumberItems, string[] FrameType, string[] DesignSect, string[] Status, string[] PMMCombo, double[] PMMRatio, double[] PRatio, double[] MMajRatio, double[] MMinRatio, string[] VMajCombo, double[] VMajRatio, string[] VMinCombo, double[] VMinRatio) GetSummaryResults_2(this cDesignSteel obj, string Name, eItemType ItemType) {
			int NumberItems;
			NumberItems = default(int);
