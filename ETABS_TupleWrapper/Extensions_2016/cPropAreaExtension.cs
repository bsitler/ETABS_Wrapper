...
namespace ETABS2016
{
    ...
    {
		public static double[] GetModifiers(this cPropArea obj, string Name) {
			double[] Value;
			Value = default(double[]);
		    var res = obj.GetModifiers(Name, ref Value);
		    return Value;
		}
		public static (int NumberNames, string[] MyName) GetNameList(this cPropArea obj, int PropType) {
			int NumberNames;
		...
		public static (string MatProp, int SteelLayoutOption, double DesignCoverTopDir1, double DesignCoverTopDir2, double DesignCoverBotDir1, double DesignCoverBotDir2) GetShellDesign(this cPropArea obj, string Name) {
			string MatProp;
		...
		public static (int NumberLayers, string[] LayerName, double[] Dist, double[] Thickness, string[] MatProp, bool[] Nonlinear, double[] MatAng, int[] NumIntegrationPts) GetShellLayer(this cPropArea obj, string Name) {
			int NumberLayers;
		...
		public static (int NumberLayers, string[] LayerName, double[] Dist, double[] Thickness, int[] MyType, int[] NumIntegrationPts, string[] MatProp, double[] MatAng, int[] S11Type, int[] S22Type, int[] S12Type) GetShellLayer_1(this cPropArea obj, string Name) {
			int NumberLayers;
			NumberLayers = default(int);
			string[] LayerName, MatProp;
			LayerName = MatProp = default(string[]);
		...
		public static int GetTypeOAPI(this cPropArea obj, string Name) {
			int PropType;
			PropType = default(int);
		    var res = obj.GetTypeOAPI(Name, ref PropType);
		    return PropType;
		}
		public static (eDeckType DeckType, eShellType ShellType, string MatProp, double Thickness, int color, string notes, string GUID) GetDeck(this cPropArea obj, string Name) {
			eDeckType DeckType;
		...
		public static (double SlabDepth, double RibDepth, double RibWidthTop, double RibWidthBot, double RibSpacing, double ShearThickness, double UnitWeight, double ShearStudDia, double ShearStudHt, double ShearStudFu) GetDeckFilled(this cPropArea obj, string Name) {
		...
		public static (double SlabDepth, double ShearStudDia, double ShearStudHt, double ShearStudFu) GetDeckSolidSlab(this cPropArea obj, string Name) {
		...
		public static (double RibDepth, double RibWidthTop, double RibWidthBot, double RibSpacing, double ShearThickness, double UnitWeight) GetDeckUnfilled(this cPropArea obj, string Name) {
		...
		public static (eSlabType SlabType, eShellType ShellType, string MatProp, double Thickness, int color, string notes, string GUID) GetSlab(this cPropArea obj, string Name) {
			eSlabType SlabType;
		...
		public static (double OverallDepth, double SlabThickness, double StemWidthTop, double StemWidthBot, double RibSpacing, int RibsParallelTo) GetSlabRibbed(this cPropArea obj, string Name) {
		...
		public static (double OverallDepth, double SlabThickness, double StemWidthTop, double StemWidthBot, double RibSpacingDir1, double RibSpacingDir2) GetSlabWaffle(this cPropArea obj, string Name) {
		...
		public static (eWallPropType WallPropType, eShellType ShellType, string MatProp, double Thickness, int color, string notes, string GUID) GetWall(this cPropArea obj, string Name) {
		...
		public static (string[] AutoSelectList, string StartingProperty) GetWallAutoSelectList(this cPropArea obj, string Name) {
