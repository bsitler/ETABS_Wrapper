...
namespace ETABS2016
{
    ...
    {
		public static (eConstraintAxis Axis, string CSys) GetDiaphragm(this cConstraint obj, string Name) {
		...
		public static (int NumberNames, string[] MyName) GetNameList(this cConstraint obj) {
			int NumberNames;
