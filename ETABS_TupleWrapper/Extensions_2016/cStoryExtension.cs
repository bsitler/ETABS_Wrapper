...
namespace ETABS2016
{
    ...
    {
		public static double GetElevation(this cStory obj, string Name) {
			double Elevation;
			Elevation = default(double);
		    var res = obj.GetElevation(Name, ref Elevation);
		    return Elevation;
		}
		public static string GetGUID(this cStory obj, string Name) {
			string GUID;
			GUID = default(string);
		    var res = obj.GetGUID(Name, ref GUID);
		    return GUID;
		}
		public static double GetHeight(this cStory obj, string Name) {
			double Height;
			Height = default(double);
		    var res = obj.GetHeight(Name, ref Height);
		    return Height;
		}
		public static bool GetMasterStory(this cStory obj, string Name) {
			bool IsMasterStory;
			IsMasterStory = default(bool);
		    var res = obj.GetMasterStory(Name, ref IsMasterStory);
		    return IsMasterStory;
		}
		public static (int NumberNames, string[] MyName) GetNameList(this cStory obj) {
			int NumberNames;
		...
		public static (bool IsMasterStory, string SimilarToStory) GetSimilarTo(this cStory obj, string Name) {
			bool IsMasterStory;
			IsMasterStory = default(bool);
		...
		public static (bool SpliceAbove, double SpliceHeight) GetSplice(this cStory obj, string Name) {
			bool SpliceAbove;
		...
		public static (int NumberStories, string[] StoryNames, double[] StoryElevations, double[] StoryHeights, bool[] IsMasterStory, string[] SimilarToStory, bool[] SpliceAbove, double[] SpliceHeight) GetStories(this cStory obj) {
			int NumberStories;
