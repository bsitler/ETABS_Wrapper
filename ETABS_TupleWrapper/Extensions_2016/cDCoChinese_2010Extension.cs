...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDCoChinese_2010 obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDCoChinese_2010 obj, int Item) {
			double Value;
			Value = default(double);
