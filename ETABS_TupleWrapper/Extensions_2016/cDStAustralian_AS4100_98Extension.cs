...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDStAustralian_AS4100_98 obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDStAustralian_AS4100_98 obj, int Item) {
			double Value;
			Value = default(double);
