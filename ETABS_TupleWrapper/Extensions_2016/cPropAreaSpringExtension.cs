...
namespace ETABS2016
{
    ...
    {
		public static (double U1, double U2, double U3, int NonlinearOption3, int SpringOption, string SoilProfile, double EndLengthRatio, double Period, int color, string notes, string iGUID) GetAreaSpringProp(this cPropAreaSpring obj, string Name) {
		...
		public static (int NumberNames, string[] MyName) GetNameList(this cPropAreaSpring obj) {
			int NumberNames;
