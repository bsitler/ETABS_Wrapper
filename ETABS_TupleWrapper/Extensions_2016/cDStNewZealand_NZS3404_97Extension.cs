...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDStNewZealand_NZS3404_97 obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDStNewZealand_NZS3404_97 obj, int Item) {
			double Value;
			Value = default(double);
