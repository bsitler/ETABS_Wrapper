...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDStIndian_IS_800_2007 obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDStIndian_IS_800_2007 obj, int Item) {
			double Value;
			Value = default(double);
