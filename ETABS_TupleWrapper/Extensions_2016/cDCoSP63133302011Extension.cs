...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDCoSP63133302011 obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDCoSP63133302011 obj, int Item) {
			double Value;
			Value = default(double);
