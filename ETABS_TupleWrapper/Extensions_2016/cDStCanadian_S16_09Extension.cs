...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDStCanadian_S16_09 obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDStCanadian_S16_09 obj, int Item) {
			double Value;
			Value = default(double);
