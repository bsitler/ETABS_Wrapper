...
namespace ETABS2016
{
    ...
    {
		public static (int NumberNames, string[] MyName) GetNameList(this cLoadCases obj, eLoadCaseType CaseType) {
			int NumberNames;
		...
		public static (eLoadCaseType CaseType, int SubType, eLoadPatternType DesignType, int DesignTypeOption, int Auto) GetTypeOAPI_1(this cLoadCases obj, string Name) {
		...
		public static (eLoadCaseType CaseType, int SubType) GetTypeOAPI(this cLoadCases obj, string Name) {
			eLoadCaseType CaseType;
			CaseType = default(eLoadCaseType);
			int SubType;
			SubType = default(int);
