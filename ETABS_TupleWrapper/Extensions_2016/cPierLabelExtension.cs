...
namespace ETABS2016
{
    ...
    {
		public static (int NumberNames, string[] MyName) GetNameList(this cPierLabel obj) {
			int NumberNames;
		...
		public static (int NumberStories, string[] StoryName, double[] AxisAngle, int[] NumAreaObjs, int[] NumLineObjs, double[] WidthBot, double[] ThicknessBot, double[] WidthTop, double[] ThicknessTop, string[] MatProp, double[] CGBotX, double[] CGBotY, double[] CGBotZ, double[] CGTopX, double[] CGTopY, double[] CGTopZ) GetSectionProperties(this cPierLabel obj, string Name) {
			int NumberStories;
