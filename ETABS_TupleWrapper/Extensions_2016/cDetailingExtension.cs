...
namespace ETABS2016
{
    ...
    {
		public static (int NumberItems, string[] BeamLineIDs) GetDetailedBeamLines(this cDetailing obj) {
			int NumberItems;
		...
		public static (string[] ObjectUniqueNames, int NumberSpans, double[] SpanLength, int[] NumLongBars, double[] LongBarDiameter, string[] LongBarNotation, double[] LongBarStartDist, int[] LongBarStartBend, int[] LongBarEndBend, double[] LongBarLength, int[] LongBarNumLayers, int[] NumTieBars, int[] NumTieVertLegs, double[] TieBarDiameter, string[] TieBarNotation, double[] TieBarStartDist, double[] TieBarSpacing, int[] TieBarType) GetDetailedBeamLineData(this cDetailing obj, string BeamLineID) {
		...
		public static (int NumberItems, string[] ColumnStackIDs) GetDetailedColumnStacks(this cDetailing obj) {
			int NumberItems;
			NumberItems = default(int);
		...
		public static (string[] ObjectUniqueNames, int NumLongBarSets, int[] NumLongBars, double[] LongBarDiameter, string[] LongBarNotation, double[] LongBarStartDist, int[] LongBarStartBend, int[] LongBarEndBend, double[] LongBarLength, int[] LongBarNumLayers, int NumTieZones, string[] TieBarZones, int[] NumTieBars, int[] NumTieVertLegs, double[] TieBarDiameter, string[] TieBarNotation, double[] TieBarStartDist, double[] TieBarSpacing, int[] TieBarType) GetDetailedColumnStackData(this cDetailing obj, string ColumnStackID) {
		...
		public static (int NumberItems, string[] Names, double[] SlabElevations, string[] GUIDs) GetDetailedSlabs(this cDetailing obj) {
			int NumberItems;
			NumberItems = default(int);
			string[] Names, GUIDs;
		...
		public static (int NumData, string[] Names, int[] NumBars, double[] BarDiameter, string[] BarNotation, string[] BarMaterial, double[] StartX, double[] StartY, double[] StartZ, double[] EndX, double[] EndY, double[] EndZ, double[] WidthLeft, double[] WidthRight, double[] OffsetFromTop, double[] OffsetFromBot, int[] StartBarBend, int[] EndBarBend, string[] GUIDs) GetDetailedSlabTopBarData(this cDetailing obj, string SlabName) {
			int NumData;
			NumData = default(int);
			string[] Names, BarNotation, BarMaterial, GUIDs;
			Names = BarNotation = BarMaterial = GUIDs = default(string[]);
		...
		public static (int NumData, string[] Names, int[] NumBars, double[] BarDiameter, string[] BarNotation, string[] BarMaterial, double[] StartX, double[] StartY, double[] StartZ, double[] EndX, double[] EndY, double[] EndZ, double[] WidthLeft, double[] WidthRight, double[] OffsetFromTop, double[] OffsetFromBot, int[] StartBarBend, int[] EndBarBend, string[] GUIDs, string[] StripNames, int[] SpanNos) GetDetailedSlabTopBarData_1(this cDetailing obj, string SlabName) {
			int NumData;
			NumData = default(int);
			string[] Names, BarNotation, BarMaterial, GUIDs, StripNames;
			Names = BarNotation = BarMaterial = GUIDs = StripNames = default(string[]);
		...
		public static (int NumberSimilarBeams, int[] NumberUniqueObjects, string[] ObjectUniqueNames) GetSimilarBeamLines(this cDetailing obj, string BeamLineID) {
		...
		public static (int NumberSimilarColumns, int[] NumberUniqueObjects, string[] ObjectUniqueNames) GetSimilarColumnStacks(this cDetailing obj, string ColumnStackID) {
		...
		public static (int NumberSimilarSlabs, string[] Names) GetSimilarSlabs(this cDetailing obj, string SlabName) {
		...
		public static (int NumberRebarSets, string[] BarSizeName, double[] BarArea, int[] NumberBars, string[] Location, double[] ClearCover, double[] StartCoord1, double[] BarLength, double[] BendingAngleStart, double[] BendingAngleEnd, string[] RebarSetGUID) GetBeamLongRebarData(this cDetailing obj, string Name) {
			int NumberRebarSets;
		...
		public static (int NumberRebarSets, string[] BarSizeName, double[] BarArea, double[] NumberLegs, string[] Location, double[] ClearCover, double[] StartCoord1, double[] Spacing, double[] Lengths, string[] RebarSetGUID) GetBeamTieRebarData(this cDetailing obj, string Name) {
			int NumberRebarSets;
			NumberRebarSets = default(int);
			string[] BarSizeName, Location, RebarSetGUID;
			BarSizeName = Location = RebarSetGUID = default(string[]);
		...
		public static (int NumberRebarSets, string[] BarSizeName, double[] BarArea, int[] NumberCBars, int[] NumberR3Bars, int[] NumberR2Bars, string[] Location, double[] ClearCover, string[] RebarSetGUID) GetColumnLongRebarData(this cDetailing obj, string Name) {
			int NumberRebarSets;
			NumberRebarSets = default(int);
			string[] BarSizeName, Location, RebarSetGUID;
			BarSizeName = Location = RebarSetGUID = default(string[]);
		...
		public static (int NumberRebarSets, string[] BarSizeName, double[] BarArea, int[] Pattern, int[] ConfineType, int[] NumberLegs2Dir, int[] NumberLegs3Dir, string[] Location, double[] ClearCover, double[] StartCoord1, double[] Spacing, double[] Heights, string[] RebarSetGUID) GetColumnTieRebarData(this cDetailing obj, string Name) {
			int NumberRebarSets;
			NumberRebarSets = default(int);
			string[] BarSizeName, Location, RebarSetGUID;
			BarSizeName = Location = RebarSetGUID = default(string[]);
