...
namespace ETABS2016
{
    ...
    {
		public static (string MatProp, string PropName, int Color, double XCenter, double YCenter, double H, double Bf, double Tf, double Tw, double Rotation) GetAngle(this cPropFrameSDShape obj, string Name, string ShapeName) {
		...
		public static (string MatProp, string PropName, int Color, double XCenter, double YCenter, double H, double Bf, double Tf, double Tw, double Bfb, double Tfb, double Rotation) GetISection(this cPropFrameSDShape obj, string Name, string ShapeName) {
			string MatProp, PropName;
			MatProp = PropName = default(string);
			int Color;
			Color = default(int);
		...
		public static (double XCenter, double YCenter, double Diameter, int NumBars, double Rotation, string RebarSize, string MatRebar) GetReinfCircle(this cPropFrameSDShape obj, string Name, string ShapeName) {
		...
		public static (int NumberItems, int[] PointNum, string[] RebarSize) GetReinfCorner(this cPropFrameSDShape obj, string Name, string ShapeName) {
			int NumberItems;
		...
		public static (int NumberItems, int[] EdgeNum, string[] RebarSize, double[] Spacing, double[] Cover) GetReinfEdge(this cPropFrameSDShape obj, string Name, string ShapeName) {
			int NumberItems;
			NumberItems = default(int);
			int[] EdgeNum;
			EdgeNum = default(int[]);
		...
		public static (double X1, double Y1, double X2, double Y2, double Spacing, string RebarSize, bool EndBars, string MatRebar) GetReinfLine(this cPropFrameSDShape obj, string Name, string ShapeName) {
		...
		public static (double XCenter, double YCenter, double H, double W, double Rotation, string MatRebar) GetReinfRectangular(this cPropFrameSDShape obj, string Name, string ShapeName) {
		...
		public static (double XCenter, double YCenter, string RebarSize, string MatRebar) GetReinfSingle(this cPropFrameSDShape obj, string Name, string ShapeName) {
		...
		public static (string MatProp, string SSOverwrite, int Color, double XCenter, double YCenter, double Diameter, bool Reinf, int NumberBars, double Rotation, double Cover, string RebarSize, string MatRebar) GetSolidCircle(this cPropFrameSDShape obj, string Name, string ShapeName) {
		...
		public static (string MatProp, string SSOverwrite, int Color, double XCenter, double YCenter, double H, double W, double Rotation, bool Reinf, string MatRebar) GetSolidRect(this cPropFrameSDShape obj, string Name, string ShapeName) {
		...
		public static (string MatProp, string PropName, int Color, double XCenter, double YCenter, double H, double Bf, double Tf, double Tw, double Rotation) GetTee(this cPropFrameSDShape obj, string Name, string ShapeName) {
			string MatProp, PropName;
			MatProp = PropName = default(string);
			int Color;
			Color = default(int);
		...
		public static (string MatProp, string PropName, int Color, double XCenter, double YCenter, double H, double Bf, double Tf, double Tw, double Rotation, bool MirrorAbout2, bool MirrorAbout3) GetConcreteL(this cPropFrameSDShape obj, string Name, string ShapeName) {
			string MatProp, PropName;
			MatProp = PropName = default(string);
			int Color;
			Color = default(int);
		...
		public static (string MatProp, string PropName, int Color, double XCenter, double YCenter, double H, double Bf, double Tf, double Tw, double Rotation, bool MirrorAbout3) GetConcreteTee(this cPropFrameSDShape obj, string Name, string ShapeName) {
			string MatProp, PropName;
			MatProp = PropName = default(string);
			int Color;
			Color = default(int);
