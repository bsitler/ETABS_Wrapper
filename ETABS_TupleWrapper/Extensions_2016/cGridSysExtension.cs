...
namespace ETABS2016
{
    ...
    {
		public static (double x, double y, double RZ) GetGridSys(this cGridSys obj, string Name) {
			double x, y, RZ;
			x = y = RZ = default(double);
		    var res = obj.GetGridSys(Name, ref x, ref y, ref RZ);
		    return (x, y, RZ);
		}
		public static (int NumberNames, string[] MyName) GetNameList(this cGridSys obj) {
			int NumberNames;
		...
		public static double[] GetTransformationMatrix(this cGridSys obj, string Name) {
			double[] Value;
			Value = default(double[]);
		    var res = obj.GetTransformationMatrix(Name, ref Value);
		    return Value;
		}
		public static (double Xo, double Yo, double RZ, string GridSysType, int NumXLines, int NumYLines, string[] GridLineIDX, string[] GridLineIDY, double[] OrdinateX, double[] OrdinateY, bool[] VisibleX, bool[] VisibleY, string[] BubbleLocX, string[] BubbleLocY) GetGridSys_2(this cGridSys obj, string Name) {
			double Xo, Yo, RZ;
		...
		public static string GetGridSysType(this cGridSys obj, string Name) {
			string GridSysType;
			GridSysType = default(string);
		    var res = obj.GetGridSysType(Name, ref GridSysType);
		    return GridSysType;
		}
		public static (int NumberNames, string[] GridSysName, string[] GridSysType) GetNameTypeList(this cGridSys obj) {
			int NumberNames;
			NumberNames = default(int);
		...
		public static (double Xo, double Yo, double RZ, bool StoryRangeIsDefault, string TopStory, string BottomStory, double BubbleSize, int GridColor, int NumXLines, string[] GridLineIDX, double[] OrdinateX, bool[] VisibleX, string[] BubbleLocX, int NumYLines, string[] GridLineIDY, double[] OrdinateY, bool[] VisibleY, string[] BubbleLocY, int NumGenLines, string[] GridLineIDGen, double[] GenOrdX1, double[] GenOrdY1, double[] GenOrdX2, double[] GenOrdY2, bool[] VisibleGen, string[] BubbleLocGen) GetGridSysCartesian(this cGridSys obj, string Name) {
		...
		public static (double Xo, double Yo, double RZ, bool StoryRangeIsDefault, string TopStory, string BottomStory, double BubbleSize, int GridColor, int NumRLines, string[] GridLineIDR, double[] OrdinateR, bool[] VisibleR, string[] BubbleLocR, int NumTLines, string[] GridLineIDT, double[] OrdinateT, bool[] VisibleT, string[] BubbleLocT) GetGridSysCylindrical(this cGridSys obj, string Name) {
			double Xo, Yo, RZ, BubbleSize;
			Xo = Yo = RZ = BubbleSize = default(double);
			bool StoryRangeIsDefault;
			StoryRangeIsDefault = default(bool);
