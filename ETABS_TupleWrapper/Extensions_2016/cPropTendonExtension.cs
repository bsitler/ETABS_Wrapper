...
namespace ETABS2016
{
    ...
    {
		public static (int NumberNames, string[] MyName) GetNameList(this cPropTendon obj) {
			int NumberNames;
		...
		public static (string MatProp, int ModelingOption, double Area, int Color, string Notes, string GUID) GetProp(this cPropTendon obj, string Name) {
