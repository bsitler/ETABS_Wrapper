...
namespace ETABS2016
{
    ...
    {
		public static string GetCode(this cDesignConcrete obj) {
			string CodeName;
			CodeName = default(string);
		    var res = obj.GetCode(ref CodeName);
		    return CodeName;
		}
		public static string GetDesignSection(this cDesignConcrete obj, string Name) {
			string PropName;
			PropName = default(string);
		    var res = obj.GetDesignSection(Name, ref PropName);
		    return PropName;
		}
		public static (int NumberItems, string[] FrameName, double[] Location, string[] TopCombo, double[] TopArea, string[] BotCombo, double[] BotArea, string[] VMajorCombo, double[] VMajorArea, string[] TLCombo, double[] TLArea, string[] TTCombo, double[] TTArea, string[] ErrorSummary, string[] WarningSummary) GetSummaryResultsBeam(this cDesignConcrete obj, string Name, eItemType ItemType) {
			int NumberItems;
		...
		public static (int NumberItems, string[] FrameName, int[] MyOption, double[] Location, string[] PMMCombo, double[] PMMArea, double[] PMMRatio, string[] VMajorCombo, double[] AVMajor, string[] VMinorCombo, double[] AVMinor, string[] ErrorSummary, string[] WarningSummary) GetSummaryResultsColumn(this cDesignConcrete obj, string Name, eItemType ItemType) {
			int NumberItems;
			NumberItems = default(int);
		...
		public static (int NumberItems, string[] FrameName, string[] LCJSRatioMajor, double[] JSRatioMajor, string[] LCJSRatioMinor, double[] JSRatioMinor, string[] LCBCCRatioMajor, double[] BCCRatioMajor, string[] LCBCCRatioMinor, double[] BCCRatioMinor, string[] ErrorSummary, string[] WarningSummary) GetSummaryResultsJoint(this cDesignConcrete obj, string Name, eItemType ItemType) {
			int NumberItems;
			NumberItems = default(int);
