...
namespace ETABS2016
{
    ...
    {
		public static (int NumberResults, string[] Obj, string[] Elm, string[] PointElm, string[] LoadCase, string[] StepType, double[] StepNum, double[] F11, double[] F22, double[] F12, double[] FMax, double[] FMin, double[] FAngle, double[] FVM, double[] M11, double[] M22, double[] M12, double[] MMax, double[] MMin, double[] MAngle, double[] V13, double[] V23, double[] VMax, double[] VAngle) AreaForceShell(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] PointElm, string[] LoadCase, string[] StepType, double[] StepNum, double[] F1, double[] F2, double[] F3, double[] M1, double[] M2, double[] M3) AreaJointForceShell(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, PointElm, LoadCase, StepType;
			Obj = Elm = PointElm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] PointElm, double[] U1, double[] U2, double[] U3, double[] R1, double[] R2, double[] R3) AssembledJointMass(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] PointElm;
		...
		public static (int NumberResults, string[] LoadCase, string[] StepType, double[] StepNum, double[] FX, double[] FY, double[] FZ, double[] MX, double[] ParamMy, double[] MZ, double GX, double GY, double GZ) BaseReact(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
		...
		public static (int NumberResults, string[] LoadCase, string[] StepType, double[] StepNum, double[] Factor) BucklingFactor(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
			string[] LoadCase, StepType;
			LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Obj, double[] ObjSta, string[] Elm, double[] ElmSta, string[] LoadCase, string[] StepType, double[] StepNum, double[] P, double[] V2, double[] V3, double[] T, double[] M2, double[] M3) FrameForce(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] PointElm, string[] LoadCase, string[] StepType, double[] StepNum, double[] F1, double[] F2, double[] F3, double[] M1, double[] M2, double[] M3) FrameJointForce(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, PointElm, LoadCase, StepType;
			Obj = Elm = PointElm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] GD, string[] LoadCase, string[] StepType, double[] StepNum, string[] DType, double[] Value) GeneralizedDispl(this cAnalysisResults obj, string Name) {
			int NumberResults;
			NumberResults = default(int);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] LoadCase, string[] StepType, double[] StepNum, double[] U1, double[] U2, double[] U3, double[] R1, double[] R2, double[] R3) JointAcc(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, LoadCase, StepType;
			Obj = Elm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] LoadCase, string[] StepType, double[] StepNum, double[] U1, double[] U2, double[] U3, double[] R1, double[] R2, double[] R3) JointAccAbs(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, LoadCase, StepType;
			Obj = Elm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] LoadCase, string[] StepType, double[] StepNum, double[] U1, double[] U2, double[] U3, double[] R1, double[] R2, double[] R3) JointDispl(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, LoadCase, StepType;
			Obj = Elm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] LoadCase, string[] StepType, double[] StepNum, double[] U1, double[] U2, double[] U3, double[] R1, double[] R2, double[] R3) JointDisplAbs(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, LoadCase, StepType;
			Obj = Elm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] LoadCase, string[] StepType, double[] StepNum, double[] F1, double[] F2, double[] F3, double[] M1, double[] M2, double[] M3) JointReact(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, LoadCase, StepType;
			Obj = Elm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] LoadCase, string[] StepType, double[] StepNum, double[] U1, double[] U2, double[] U3, double[] R1, double[] R2, double[] R3) JointVel(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, LoadCase, StepType;
			Obj = Elm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] LoadCase, string[] StepType, double[] StepNum, double[] U1, double[] U2, double[] U3, double[] R1, double[] R2, double[] R3) JointVelAbs(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, LoadCase, StepType;
			Obj = Elm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] LoadCase, string[] StepType, double[] StepNum, double[] U1, double[] U2, double[] U3, double[] R1, double[] R2, double[] R3) LinkDeformation(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, LoadCase, StepType;
			Obj = Elm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] PointElm, string[] LoadCase, string[] StepType, double[] StepNum, double[] P, double[] V2, double[] V3, double[] T, double[] M2, double[] M3) LinkForce(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, PointElm, LoadCase, StepType;
			Obj = Elm = PointElm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] PointElm, string[] LoadCase, string[] StepType, double[] StepNum, double[] F1, double[] F2, double[] F3, double[] M1, double[] M2, double[] M3) LinkJointForce(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, PointElm, LoadCase, StepType;
			Obj = Elm = PointElm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] LoadCase, string[] ItemType, string[] Item, double[] Stat, double[] Dyn) ModalLoadParticipationRatios(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
		...
		public static (int NumberResults, string[] LoadCase, string[] StepType, double[] StepNum, double[] Period, double[] UX, double[] UY, double[] UZ, double[] SumUX, double[] SumUY, double[] SumUZ, double[] RX, double[] RY, double[] RZ, double[] SumRX, double[] SumRY, double[] SumRZ) ModalParticipatingMassRatios(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
			string[] LoadCase, StepType;
			LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] LoadCase, string[] StepType, double[] StepNum, double[] Period, double[] UX, double[] UY, double[] UZ, double[] RX, double[] RY, double[] RZ, double[] ModalMass, double[] ModalStiff) ModalParticipationFactors(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
			string[] LoadCase, StepType;
			LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] LoadCase, string[] StepType, double[] StepNum, double[] Period, double[] Frequency, double[] CircFreq, double[] EigenValue) ModalPeriod(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
			string[] LoadCase, StepType;
			LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Obj, string[] Elm, string[] LoadCase, string[] StepType, double[] StepNum, double[] U1, double[] U2, double[] U3, double[] R1, double[] R2, double[] R3) ModeShape(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
			string[] Obj, Elm, LoadCase, StepType;
			Obj = Elm = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] Elm, string[] LoadCase, string[] StepType, double[] StepNum, double[] U1, double[] U2, double[] U3, double[] R1, double[] R2, double[] R3) PanelZoneDeformation(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
		...
		public static (int NumberResults, string[] Elm, string[] PointElm, string[] LoadCase, string[] StepType, double[] StepNum, double[] P, double[] V2, double[] V3, double[] T, double[] M2, double[] M3) PanelZoneForce(this cAnalysisResults obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberResults;
			NumberResults = default(int);
		...
		public static (int NumberResults, string[] SCut, string[] LoadCase, string[] StepType, double[] StepNum, double[] F1, double[] F2, double[] F3, double[] M1, double[] M2, double[] M3) SectionCutAnalysis(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
		...
		public static (int NumberResults, string[] SCut, string[] LoadCase, string[] StepType, double[] StepNum, double[] P, double[] V2, double[] V3, double[] T, double[] M2, double[] M3) SectionCutDesign(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
			string[] SCut, LoadCase, StepType;
			SCut = LoadCase = StepType = default(string[]);
		...
		public static (int NumberResults, string[] StoryName, string[] PierName, string[] LoadCase, string[] Location, double[] P, double[] V2, double[] V3, double[] T, double[] M2, double[] M3) PierForce(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
		...
		public static (int NumberResults, string[] StoryName, string[] SpandrelName, string[] LoadCase, string[] Location, double[] P, double[] V2, double[] V3, double[] T, double[] M2, double[] M3) SpandrelForce(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
		...
		public static (int NumberResults, string[] Story, string[] Label, string[] Name, string[] LoadCase, string[] StepType, double[] StepNum, double[] DisplacementX, double[] DisplacementY, double[] DriftX, double[] DriftY) JointDrifts(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
		...
		public static (int NumberResults, string[] Story, string[] LoadCase, string[] StepType, double[] StepNum, string[] Direction, double[] Drift, string[] Label, double[] X, double[] Y, double[] Z) StoryDrifts(this cAnalysisResults obj) {
			int NumberResults;
			NumberResults = default(int);
