...
namespace ETABS2016
{
    ...
    {
		public static (int NumberItems, string[] AreaName, string[] LoadPat, int[] MyType, double[] Value, string[] PatternName) GetLoadTemperature(this cAreaElm obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberItems;
		...
		public static (int NumberItems, string[] AreaName, string[] LoadPat, string[] CSys, int[] Dir, double[] Value) GetLoadUniform(this cAreaElm obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberItems;
			NumberItems = default(int);
		...
		public static double GetLocalAxes(this cAreaElm obj, string Name) {
			double Ang;
			Ang = default(double);
		    var res = obj.GetLocalAxes(Name, ref Ang);
		    return Ang;
		}
		public static string GetMaterialOverwrite(this cAreaElm obj, string Name) {
			string PropName;
			PropName = default(string);
		    var res = obj.GetMaterialOverwrite(Name, ref PropName);
		    return PropName;
		}
		public static double[] GetModifiers(this cAreaElm obj, string Name) {
			double[] Value;
			Value = default(double[]);
		    var res = obj.GetModifiers(Name, ref Value);
		    return Value;
		}
		public static (int NumberNames, string[] MyName) GetNameList(this cAreaElm obj) {
			int NumberNames;
		...
		public static string GetObj(this cAreaElm obj, string Name) {
			string Obj;
			Obj = default(string);
		    var res = obj.GetObj(Name, ref Obj);
		    return Obj;
		}
		public static (int OffsetType, string OffsetPattern, double OffsetPatternSF, double[] Offset) GetOffsets(this cAreaElm obj, string Name) {
			int OffsetType;
		...
		public static (int NumberPoints, string[] Point) GetPoints(this cAreaElm obj, string Name) {
			int NumberPoints;
		...
		public static string GetProperty(this cAreaElm obj, string Name) {
			string PropName;
			PropName = default(string);
		    var res = obj.GetProperty(Name, ref PropName);
		    return PropName;
		}
		public static (int ThicknessType, string ThicknessPattern, double ThicknessPatternSF, double[] Thickness) GetThickness(this cAreaElm obj, string Name) {
			int ThicknessType;
		...
		public static double[] GetTransformationMatrix(this cAreaElm obj, string Name) {
			double[] Value;
			Value = default(double[]);
