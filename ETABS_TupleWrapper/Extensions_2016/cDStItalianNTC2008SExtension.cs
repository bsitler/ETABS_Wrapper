...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDStItalianNTC2008S obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDStItalianNTC2008S obj, int Item) {
			double Value;
			Value = default(double);
