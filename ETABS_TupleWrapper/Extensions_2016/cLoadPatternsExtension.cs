...
namespace ETABS2016
{
    ...
    {
		public static string GetAutoSeismicCode(this cLoadPatterns obj, string Name) {
			string CodeName;
			CodeName = default(string);
		    var res = obj.GetAutoSeismicCode(Name, ref CodeName);
		    return CodeName;
		}
		public static string GetAutoWindCode(this cLoadPatterns obj, string Name) {
			string CodeName;
			CodeName = default(string);
		    var res = obj.GetAutoWindCode(Name, ref CodeName);
		    return CodeName;
		}
		public static eLoadPatternType GetLoadType(this cLoadPatterns obj, string Name) {
			eLoadPatternType MyType;
			MyType = default(eLoadPatternType);
		    var res = obj.GetLoadType(Name, ref MyType);
		    return MyType;
		}
		public static (int NumberNames, string[] MyName) GetNameList(this cLoadPatterns obj) {
			int NumberNames;
		...
		public static double GetSelfWTMultiplier(this cLoadPatterns obj, string Name) {
