...
namespace ETABS2016
{
    ...
    {
		public static string AddMaterial(this cPropMaterial obj, eMatType MatType, string Region, string Standard, string Grade, string UserName) {
			string Name;
			Name = default(string);
		    var res = obj.AddMaterial(ref Name, MatType, Region, Standard, Grade, UserName);
		    return Name;
		}
		public static (double ModalRatio, double ViscousMassCoeff, double ViscousStiffCoeff, double HystereticMassCoeff, double HystereticStiffCoeff) GetDamping(this cPropMaterial obj, string Name, double Temp) {
		...
		public static (int MyOption, int NumberLoads, string[] LoadPat, double[] SF) GetMassSource(this cPropMaterial obj) {
		...
		public static (eMatType MatType, int Color, string Notes, string GUID) GetMaterial(this cPropMaterial obj, string Name) {
			eMatType MatType;
		...
		public static (double[] E, double[] U, double[] A, double[] G) GetMPAnisotropic(this cPropMaterial obj, string Name, double Temp) {
			double[] E, U, A, G;
			E = U = A = G = default(double[]);
		    var res = obj.GetMPAnisotropic(Name, ref E, ref U, ref A, ref G, Temp);
		    return (E, U, A, G);
		}
		public static (double E, double U, double A, double G) GetMPIsotropic(this cPropMaterial obj, string Name, double Temp) {
			double E, U, A, G;
			E = U = A = G = default(double);
		    var res = obj.GetMPIsotropic(Name, ref E, ref U, ref A, ref G, Temp);
		    return (E, U, A, G);
		}
		public static (double[] E, double[] U, double[] A, double[] G) GetMPOrthotropic(this cPropMaterial obj, string Name, double Temp) {
			double[] E, U, A, G;
			E = U = A = G = default(double[]);
		    var res = obj.GetMPOrthotropic(Name, ref E, ref U, ref A, ref G, Temp);
		    return (E, U, A, G);
		}
		public static (double E, double A) GetMPUniaxial(this cPropMaterial obj, string Name, double Temp) {
			double E, A;
			E = A = default(double);
		    var res = obj.GetMPUniaxial(Name, ref E, ref A, Temp);
		    return (E, A);
		}
		public static (int NumberNames, string[] MyName) GetNameList(this cPropMaterial obj, eMatType MatType) {
			int NumberNames;
		...
		public static (double Fc, bool IsLightweight, double FcsFactor, int SSType, int SSHysType, double StrainAtFc, double StrainUltimate, double FrictionAngle, double DilatationalAngle) GetOConcrete(this cPropMaterial obj, string Name, double Temp) {
		...
		public static (double Fc, bool IsLightweight, double FcsFactor, int SSType, int SSHysType, double StrainAtFc, double StrainUltimate, double FinalSlope, double FrictionAngle, double DilatationalAngle) GetOConcrete_1(this cPropMaterial obj, string Name, double Temp) {
		...
		public static (double FrictionAngle, double DilatationalAngle) GetONoDesign(this cPropMaterial obj, string Name, double Temp) {
		...
		public static (double Fy, double Fu, double EFy, double EFu, int SSType, int SSHysType, double StrainAtHardening, double StrainUltimate, bool UseCaltransSSDefaults) GetORebar(this cPropMaterial obj, string Name, double Temp) {
		...
		public static (double Fy, double Fu, double EFy, double EFu, int SSType, int SSHysType, double StrainAtHardening, double StrainUltimate, double FinalSlope, bool UseCaltransSSDefaults) GetORebar_1(this cPropMaterial obj, string Name, double Temp) {
		...
		public static (double Fy, double Fu, double EFy, double EFu, int SSType, int SSHysType, double StrainAtHardening, double StrainAtMaxStress, double StrainAtRupture) GetOSteel(this cPropMaterial obj, string Name, double Temp) {
		...
		public static (double Fy, double Fu, double EFy, double EFu, int SSType, int SSHysType, double StrainAtHardening, double StrainAtMaxStress, double StrainAtRupture, double FinalSlope) GetOSteel_1(this cPropMaterial obj, string Name, double Temp) {
		...
		public static (double Fy, double Fu, int SSType, int SSHysType) GetOTendon(this cPropMaterial obj, string Name, double Temp) {
			double Fy, Fu;
		...
		public static (double Fy, double Fu, int SSType, int SSHysType, double FinalSlope) GetOTendon_1(this cPropMaterial obj, string Name, double Temp) {
		...
		public static (int NumberPoints, int[] PointID, double[] Strain, double[] Stress) GetSSCurve(this cPropMaterial obj, string Name, string SectName, double RebarArea, double Temp) {
			int NumberPoints;
		...
		public static (int NumberItems, double[] Temp) GetTemp(this cPropMaterial obj, string Name) {
			int NumberItems;
		...
		public static (eMatType MatType, int SymType) GetTypeOAPI(this cPropMaterial obj, string Name) {
			eMatType MatType;
			MatType = default(eMatType);
			int SymType;
			SymType = default(int);
		...
		public static (double W, double M) GetWeightAndMass(this cPropMaterial obj, string Name, double Temp) {
			double W, M;
			W = M = default(double);
		    var res = obj.GetWeightAndMass(Name, ref W, ref M, Temp);
		    return (W, M);
		}
		public static (bool IncludeElements, bool IncludeAddedMass, bool IncludeLoads, int NumberLoads, string[] LoadPat, double[] sf) GetMassSource_1(this cPropMaterial obj) {
