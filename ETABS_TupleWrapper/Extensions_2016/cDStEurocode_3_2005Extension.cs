...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDStEurocode_3_2005 obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDStEurocode_3_2005 obj, int Item) {
			double Value;
			Value = default(double);
