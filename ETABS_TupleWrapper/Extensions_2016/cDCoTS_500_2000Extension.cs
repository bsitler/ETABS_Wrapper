...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDCoTS_500_2000 obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDCoTS_500_2000 obj, int Item) {
			double Value;
			Value = default(double);
