...
namespace ETABS2016
{
    ...
    {
		public static (int NumberLoads, string[] LoadType, string[] LoadName, string[] Func, double[] SF, double[] Tf, double[] At, string[] CSys, double[] Ang) GetLoads(this cCaseModalHistoryNonlinear obj, string Name) {
			int NumberLoads;
