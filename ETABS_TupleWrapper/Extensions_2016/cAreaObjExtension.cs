...
namespace ETABS2016
{
    ...
    {
		public static (double[] X, double[] Y, double[] Z, string Name) AddByCoord(this cAreaObj obj, int NumberPoints, string PropName, string UserName, string CSys) {
			double[] X, Y, Z;
		...
		public static (string[] Point, string Name) AddByPoint(this cAreaObj obj, int NumberPoints, string PropName, string UserName) {
			string[] Point;
		...
		public static bool GetEdgeConstraint(this cAreaObj obj, string Name) {
		...
		public static (int NElm, string[] Elm) GetElm(this cAreaObj obj, string Name) {
			int NElm;
			NElm = default(int);
			string[] Elm;
			Elm = default(string[]);
		...
		public static string GetGUID(this cAreaObj obj, string Name) {
			string GUID;
			GUID = default(string);
		    var res = obj.GetGUID(Name, ref GUID);
		    return GUID;
		}
		public static (int NumberItems, string[] AreaName, string[] LoadPat, int[] MyType, double[] Value, string[] PatternName) GetLoadTemperature(this cAreaObj obj, string Name, eItemType ItemType) {
			int NumberItems;
		...
		public static (int NumberItems, string[] AreaName, string[] LoadPat, string[] CSys, int[] Dir, double[] Value) GetLoadUniform(this cAreaObj obj, string Name, eItemType ItemType) {
			int NumberItems;
			NumberItems = default(int);
		...
		public static (int NumberItems, string[] AreaName, string[] LoadPat, string[] CSys, int[] Dir, double[] Value, int[] DistType) GetLoadUniformToFrame(this cAreaObj obj, string Name, eItemType ItemType) {
			int NumberItems;
			NumberItems = default(int);
			string[] AreaName, LoadPat, CSys;
			AreaName = LoadPat = CSys = default(string[]);
		...
		public static (int NumberItems, string[] AreaName, string[] LoadPat, int[] MyType, double[] Cp) GetLoadWindPressure(this cAreaObj obj, string Name, eItemType ItemType) {
			int NumberItems;
			NumberItems = default(int);
		...
		public static (double Ang, bool Advanced) GetLocalAxes(this cAreaObj obj, string Name) {
			double Ang;
			Ang = default(double);
			bool Advanced;
		...
		public static double GetMass(this cAreaObj obj, string Name) {
			double MassOverL2;
			MassOverL2 = default(double);
		    var res = obj.GetMass(Name, ref MassOverL2);
		    return MassOverL2;
		}
		public static string GetMaterialOverwrite(this cAreaObj obj, string Name) {
			string PropName;
			PropName = default(string);
		    var res = obj.GetMaterialOverwrite(Name, ref PropName);
		    return PropName;
		}
		public static double[] GetModifiers(this cAreaObj obj, string Name) {
			double[] Value;
			Value = default(double[]);
		    var res = obj.GetModifiers(Name, ref Value);
		    return Value;
		}
		public static (int NumberNames, string[] MyName) GetNameList(this cAreaObj obj) {
			int NumberNames;
		...
		public static bool GetOpening(this cAreaObj obj, string Name) {
			bool IsOpening;
			IsOpening = default(bool);
		    var res = obj.GetOpening(Name, ref IsOpening);
		    return IsOpening;
		}
		public static (int NumberPoints, string[] Point) GetPoints(this cAreaObj obj, string Name) {
			int NumberPoints;
		...
		public static string GetProperty(this cAreaObj obj, string Name) {
			string PropName;
			PropName = default(string);
		    var res = obj.GetProperty(Name, ref PropName);
		    return PropName;
		}
		public static bool GetSelected(this cAreaObj obj, string Name) {
			bool Selected;
			Selected = default(bool);
		    var res = obj.GetSelected(Name, ref Selected);
		    return Selected;
		}
		public static (int NumberEdges, bool[] Selected) GetSelectedEdge(this cAreaObj obj, string Name) {
			int NumberEdges;
		...
		public static double[] GetTransformationMatrix(this cAreaObj obj, string Name, bool IsGlobal) {
			double[] Value;
			Value = default(double[]);
		    var res = obj.GetTransformationMatrix(Name, ref Value, IsGlobal);
		    return Value;
		}
		public static eAreaDesignOrientation GetDesignOrientation(this cAreaObj obj, string Name) {
		...
		public static (int NumberNames, string[] MyName) GetNameListOnStory(this cAreaObj obj, string StoryName) {
			int NumberNames;
			NumberNames = default(int);
			string[] MyName;
			MyName = default(string[]);
		...
		public static string GetDiaphragm(this cAreaObj obj, string Name) {
			string DiaphragmName;
			DiaphragmName = default(string);
		    var res = obj.GetDiaphragm(Name, ref DiaphragmName);
		    return DiaphragmName;
		}
		public static (int NumberNames, string[] MyName, string[] MyLabel, string[] MyStory) GetLabelNameList(this cAreaObj obj) {
			int NumberNames;
			NumberNames = default(int);
		...
		public static (string Label, string Story) GetLabelFromName(this cAreaObj obj, string Name) {
			string Label, Story;
			Label = Story = default(string);
		    var res = obj.GetLabelFromName(Name, ref Label, ref Story);
		    return (Label, Story);
		}
		public static string GetNameFromLabel(this cAreaObj obj, string Label, string Story) {
			string Name;
			Name = default(string);
		    var res = obj.GetNameFromLabel(Label, Story, ref Name);
		    return Name;
		}
		public static (int NumberRebarLayers, string[] LayerID, eWallPierRebarLayerType[] LayerType, double[] ClearCover, string[] BarSizeName, double[] BarArea, double[] BarSpacing, int[] NumberBars, bool[] Confined, double[] EndZoneLength, double[] EndZoneThickness, double[] EndZoneOffset) GetRebarDataPier(this cAreaObj obj, string Name) {
		...
		public static (int NumberRebarLayers, string[] LayerID, eWallSpandrelRebarLayerType[] LayerType, double[] ClearCover, int[] BarSizeIndex, double[] BarArea, double[] BarSpacing, int[] NumberBars, bool[] Confined) GetRebarDataSpandrel(this cAreaObj obj, string Name) {
			int NumberRebarLayers;
			NumberRebarLayers = default(int);
			string[] LayerID;
		...
		public static (int NumberNames, string[] MyName, eAreaDesignOrientation[] DesignOrientation, int NumberBoundaryPts, int[] PointDelimiter, string[] PointNames, double[] PointX, double[] PointY, double[] PointZ) GetAllAreas(this cAreaObj obj) {
		...
		public static string GetPier(this cAreaObj obj, string Name) {
			string PierName;
			PierName = default(string);
		    var res = obj.GetPier(Name, ref PierName);
		    return PierName;
		}
		public static string GetSpandrel(this cAreaObj obj, string Name) {
			string SpandrelName;
			SpandrelName = default(string);
		    var res = obj.GetSpandrel(Name, ref SpandrelName);
		    return SpandrelName;
		}
		public static string GetSpringAssignment(this cAreaObj obj, string Name) {
			string SpringProp;
