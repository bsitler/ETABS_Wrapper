...
namespace ETABS2016
{
    ...
    {
		public static (double Length1, double Length2, double RZ) GetEndLengthOffset(this cLineElm obj, string Name) {
		...
		public static (double[] Offset1, double[] Offset2) GetInsertionPoint(this cLineElm obj, string Name) {
			double[] Offset1, Offset2;
			Offset1 = Offset2 = default(double[]);
		    var res = obj.GetInsertionPoint(Name, ref Offset1, ref Offset2);
		    return (Offset1, Offset2);
		}
		public static (int NumberItems, string[] LineName, string[] LoadPat, int[] MyType, string[] CSys, int[] Dir, double[] RD1, double[] RD2, double[] Dist1, double[] Dist2, double[] Val1, double[] Val2) GetLoadDistributed(this cLineElm obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberItems;
		...
		public static (int NumberItems, string[] LineName, string[] LoadPat, int[] MyType, string[] CSys, int[] Dir, double[] RelDist, double[] Dist, double[] Val) GetLoadPoint(this cLineElm obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberItems;
			NumberItems = default(int);
			string[] LineName, LoadPat, CSys;
			LineName = LoadPat = CSys = default(string[]);
		...
		public static (int NumberItems, string[] LineName, string[] LoadPat, int[] MyType, double[] Val, string[] PatternName) GetLoadTemperature(this cLineElm obj, string Name, eItemTypeElm ItemTypeElm) {
			int NumberItems;
			NumberItems = default(int);
		...
		public static double GetLocalAxes(this cLineElm obj, string Name) {
			double Ang;
			Ang = default(double);
		    var res = obj.GetLocalAxes(Name, ref Ang);
		    return Ang;
		}
		public static string GetMaterialOverwrite(this cLineElm obj, string Name) {
			string PropName;
			PropName = default(string);
		    var res = obj.GetMaterialOverwrite(Name, ref PropName);
		    return PropName;
		}
		public static double[] GetModifiers(this cLineElm obj, string Name) {
			double[] Value;
			Value = default(double[]);
		    var res = obj.GetModifiers(Name, ref Value);
		    return Value;
		}
		public static (int NumberNames, string[] MyName) GetNameList(this cLineElm obj) {
			int NumberNames;
		...
		public static (string Obj, int ObjType, double RDI, double RDJ) GetObj(this cLineElm obj, string Name) {
			string Obj;
			Obj = default(string);
			int ObjType;
			ObjType = default(int);
		...
		public static (string Point1, string Point2) GetPoints(this cLineElm obj, string Name) {
			string Point1, Point2;
			Point1 = Point2 = default(string);
		    var res = obj.GetPoints(Name, ref Point1, ref Point2);
		    return (Point1, Point2);
		}
		public static (string PropName, int ObjType, bool Var, double SVarRelStartLoc, double SVarTotalLength) GetProperty(this cLineElm obj, string Name) {
			string PropName;
			PropName = default(string);
			int ObjType;
			ObjType = default(int);
		...
		public static (bool[] II, bool[] JJ, double[] StartValue, double[] EndValue) GetReleases(this cLineElm obj, string Name) {
			bool[] II, JJ;
			II = JJ = default(bool[]);
		...
		public static (bool LimitCompressionExists, double LimitCompression, bool LimitTensionExists, double LimitTension) GetTCLimits(this cLineElm obj, string Name) {
		...
		public static double[] GetTransformationMatrix(this cLineElm obj, string Name) {
			double[] Value;
			Value = default(double[]);
