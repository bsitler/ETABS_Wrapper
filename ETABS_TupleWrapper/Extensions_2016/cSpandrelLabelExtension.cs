...
namespace ETABS2016
{
    ...
    {
		public static bool GetSpandrel(this cSpandrelLabel obj, string Name) {
			bool IsMultiStory;
			IsMultiStory = default(bool);
		    var res = obj.GetSpandrel(Name, ref IsMultiStory);
		    return IsMultiStory;
		}
		public static (int NumberNames, string[] MyName, bool[] IsMultiStory) GetNameList(this cSpandrelLabel obj) {
			int NumberNames;
