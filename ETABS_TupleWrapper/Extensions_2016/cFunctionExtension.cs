...
namespace ETABS2016
{
    ...
    {
		public static (int NumberNames, string[] MyName) GetNameList(this cFunction obj, int FuncType) {
			int NumberNames;
		...
		public static (int FuncType, int AddType) GetTypeOAPI(this cFunction obj, string Name) {
		...
		public static (int NumberItems, double[] MyTime, double[] Value) GetValues(this cFunction obj, string Name) {
			int NumberItems;
