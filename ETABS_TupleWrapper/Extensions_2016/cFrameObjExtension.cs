...
namespace ETABS2016
{
    ...
    {
		public static string AddByCoord(this cFrameObj obj, double XI, double YI, double ZI, double XJ, double YJ, double ZJ, string PropName, string UserName, string CSys) {
			string Name;
			Name = default(string);
		    var res = obj.AddByCoord(XI, YI, ZI, XJ, YJ, ZJ, ref Name, PropName, UserName, CSys);
		    return Name;
		}
		public static string AddByPoint(this cFrameObj obj, string Point1, string Point2, string PropName, string UserName) {
			string Name;
			Name = default(string);
		    var res = obj.AddByPoint(Point1, Point2, ref Name, PropName, UserName);
		    return Name;
		}
		public static int GetDesignProcedure(this cFrameObj obj, string Name) {
			int MyType;
			MyType = default(int);
		    var res = obj.GetDesignProcedure(Name, ref MyType);
		    return MyType;
		}
		public static (int NElm, string[] Elm, double[] RDI, double[] RDJ) GetElm(this cFrameObj obj, string Name) {
			int NElm;
			NElm = default(int);
			string[] Elm;
			Elm = default(string[]);
		...
		public static (bool AutoOffset, double Length1, double Length2, double RZ) GetEndLengthOffset(this cFrameObj obj, string Name) {
			bool AutoOffset;
		...
		public static string GetGUID(this cFrameObj obj, string Name) {
			string GUID;
			GUID = default(string);
		    var res = obj.GetGUID(Name, ref GUID);
		    return GUID;
		}
		public static (int NumberHinges, int[] HingeNum, string[] Prop, int[] MyType, int[] Behavior, string[] Source, double[] RD) GetHingeAssigns(this cFrameObj obj, string Name) {
			int NumberHinges;
		...
		public static (int CardinalPoint, bool Mirror2, bool StiffTransform, double[] Offset1, double[] Offset2, string CSys) GetInsertionPoint(this cFrameObj obj, string Name) {
			int CardinalPoint;
		...
		public static (int NumberItems, string[] FrameName, int[] MyType, int[] Loc, double[] RD1, double[] RD2, double[] Dist1, double[] Dist2) GetLateralBracing(this cFrameObj obj, string Name) {
			int NumberItems;
		...
		public static (int NumberItems, string[] FrameName, string[] LoadPat, int[] MyType, string[] CSys, int[] Dir, double[] RD1, double[] RD2, double[] Dist1, double[] Dist2, double[] Val1, double[] Val2) GetLoadDistributed(this cFrameObj obj, string Name, eItemType ItemType) {
			int NumberItems;
			NumberItems = default(int);
		...
		public static (int NumberItems, string[] FrameName, string[] LoadPat, int[] MyType, string[] CSys, int[] Dir, double[] RelDist, double[] Dist, double[] Val) GetLoadPoint(this cFrameObj obj, string Name, eItemType ItemType) {
			int NumberItems;
			NumberItems = default(int);
			string[] FrameName, LoadPat, CSys;
			FrameName = LoadPat = CSys = default(string[]);
		...
		public static (int NumberItems, string[] FrameName, string[] LoadPat, int[] MyType, double[] Val, string[] PatternName) GetLoadTemperature(this cFrameObj obj, string Name, eItemType ItemType) {
			int NumberItems;
			NumberItems = default(int);
		...
		public static (double Ang, bool Advanced) GetLocalAxes(this cFrameObj obj, string Name) {
			double Ang;
			Ang = default(double);
			bool Advanced;
		...
		public static double GetMass(this cFrameObj obj, string Name) {
			double MassOverL;
			MassOverL = default(double);
		    var res = obj.GetMass(Name, ref MassOverL);
		    return MassOverL;
		}
		public static string GetMaterialOverwrite(this cFrameObj obj, string Name) {
			string PropName;
			PropName = default(string);
		    var res = obj.GetMaterialOverwrite(Name, ref PropName);
		    return PropName;
		}
		public static double[] GetModifiers(this cFrameObj obj, string Name) {
			double[] Value;
			Value = default(double[]);
		    var res = obj.GetModifiers(Name, ref Value);
		    return Value;
		}
		public static (int NumberNames, string[] MyName) GetNameList(this cFrameObj obj) {
			int NumberNames;
		...
		public static (int MyType, double MaxSegSize, int MinSections, bool NoOutPutAndDesignAtElementEnds, bool NoOutPutAndDesignAtPointLoads) GetOutputStations(this cFrameObj obj, string Name) {
		...
		public static (string Point1, string Point2) GetPoints(this cFrameObj obj, string Name) {
			string Point1, Point2;
			Point1 = Point2 = default(string);
		    var res = obj.GetPoints(Name, ref Point1, ref Point2);
		    return (Point1, Point2);
		}
		public static (bool[] II, bool[] JJ, double[] StartValue, double[] EndValue) GetReleases(this cFrameObj obj, string Name) {
			bool[] II, JJ;
			II = JJ = default(bool[]);
		...
		public static (string PropName, string SAuto) GetSection(this cFrameObj obj, string Name) {
		...
		public static (string PropName, double SVarTotalLength, double SVarRelStartLoc) GetSectionNonPrismatic(this cFrameObj obj, string Name) {
			string PropName;
			PropName = default(string);
		...
		public static bool GetSelected(this cFrameObj obj, string Name) {
			bool Selected;
			Selected = default(bool);
		    var res = obj.GetSelected(Name, ref Selected);
		    return Selected;
		}
		public static (bool LimitCompressionExists, double LimitCompression, bool LimitTensionExists, double LimitTension) GetTCLimits(this cFrameObj obj, string Name) {
		...
		public static double[] GetTransformationMatrix(this cFrameObj obj, string Name, bool IsGlobal) {
			double[] Value;
			Value = default(double[]);
		    var res = obj.GetTransformationMatrix(Name, ref Value, IsGlobal);
		    return Value;
		}
		public static (int SpliceOption, double Height) GetColumnSpliceOverwrite(this cFrameObj obj, string Name) {
			int SpliceOption;
		...
		public static (int NumberNames, string[] MyName) GetNameListOnStory(this cFrameObj obj, string StoryName) {
			int NumberNames;
			NumberNames = default(int);
			string[] MyName;
			MyName = default(string[]);
		...
		public static (int NumberNames, string[] MyName, string[] MyLabel, string[] MyStory) GetLabelNameList(this cFrameObj obj) {
			int NumberNames;
			NumberNames = default(int);
		...
		public static (string Label, string Story) GetLabelFromName(this cFrameObj obj, string Name) {
			string Label, Story;
			Label = Story = default(string);
		    var res = obj.GetLabelFromName(Name, ref Label, ref Story);
		    return (Label, Story);
		}
		public static string GetNameFromLabel(this cFrameObj obj, string Label, string Story) {
			string Name;
			Name = default(string);
		    var res = obj.GetNameFromLabel(Label, Story, ref Name);
		    return Name;
		}
		public static (string SupportName1, eObjType SupportType1, string SupportName2, eObjType SupportType2) GetSupports(this cFrameObj obj, string Name) {
		...
		public static (int NumberNames, string[] MyName, string[] PropName, string[] StoryName, string[] PointName1, string[] PointName2, double[] Point1X, double[] Point1Y, double[] Point1Z, double[] Point2X, double[] Point2Y, double[] Point2Z, double[] Angle, double[] Offset1X, double[] Offset2X, double[] Offset1Y, double[] Offset2Y, double[] Offset1Z, double[] Offset2Z, int[] CardinalPoint) GetAllFrames(this cFrameObj obj, string csys) {
			int NumberNames;
			NumberNames = default(int);
		...
		public static eFrameDesignOrientation GetDesignOrientation(this cFrameObj obj, string Name) {
		...
		public static string GetPier(this cFrameObj obj, string Name) {
			string PierName;
			PierName = default(string);
		    var res = obj.GetPier(Name, ref PierName);
		    return PierName;
		}
		public static string GetSpandrel(this cFrameObj obj, string Name) {
			string SpandrelName;
			SpandrelName = default(string);
		    var res = obj.GetSpandrel(Name, ref SpandrelName);
		    return SpandrelName;
		}
		public static string GetSpringAssignment(this cFrameObj obj, string Name) {
			string SpringProp;
