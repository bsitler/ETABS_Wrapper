...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDCoMexican_RCDF_2004 obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDCoMexican_RCDF_2004 obj, int Item) {
			double Value;
			Value = default(double);
