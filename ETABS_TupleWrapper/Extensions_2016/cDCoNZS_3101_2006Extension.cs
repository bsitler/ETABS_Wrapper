...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDCoNZS_3101_2006 obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDCoNZS_3101_2006 obj, int Item) {
			double Value;
			Value = default(double);
