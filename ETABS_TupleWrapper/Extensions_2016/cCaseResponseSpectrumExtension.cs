...
namespace ETABS2016
{
    ...
    {
		public static double GetDampConstant(this cCaseResponseSpectrum obj, string Name) {
			double Damp;
			Damp = default(double);
		    var res = obj.GetDampConstant(Name, ref Damp);
		    return Damp;
		}
		public static (int DampType, int NumberItems, double[] Time, double[] Damp) GetDampInterpolated(this cCaseResponseSpectrum obj, string Name) {
		...
		public static (int NumberItems, int[] Mode, double[] Damp) GetDampOverrides(this cCaseResponseSpectrum obj, string Name) {
			int NumberItems;
		...
		public static (int DampType, double DampA, double DampB, double DampF1, double DampF2, double DampD1, double DampD2) GetDampProportional(this cCaseResponseSpectrum obj, string Name) {
			int DampType;
		...
		public static int GetDampType(this cCaseResponseSpectrum obj, string Name) {
			int DampType;
			DampType = default(int);
		    var res = obj.GetDampType(Name, ref DampType);
		    return DampType;
		}
		public static (int Num, string[] Diaph, double[] Eccen) GetDiaphragmEccentricityOverride(this cCaseResponseSpectrum obj, string Name) {
			int Num;
			Num = default(int);
			string[] Diaph;
		...
		public static (int MyType, double SF) GetDirComb(this cCaseResponseSpectrum obj, string Name) {
			int MyType;
			MyType = default(int);
			double SF;
			SF = default(double);
		...
		public static double GetEccentricity(this cCaseResponseSpectrum obj, string Name) {
			double Eccen;
			Eccen = default(double);
		    var res = obj.GetEccentricity(Name, ref Eccen);
		    return Eccen;
		}
		public static (int NumberLoads, string[] LoadName, string[] Func, double[] SF, string[] CSys, double[] Ang) GetLoads(this cCaseResponseSpectrum obj, string Name) {
			int NumberLoads;
		...
		public static string GetModalCase(this cCaseResponseSpectrum obj, string Name) {
			string ModalCase;
			ModalCase = default(string);
		    var res = obj.GetModalCase(Name, ref ModalCase);
		    return ModalCase;
		}
		public static (int MyType, double F1, double F2, double Td) GetModalComb(this cCaseResponseSpectrum obj, string Name) {
			int MyType;
			MyType = default(int);
			double F1, F2, Td;
		...
		public static (int MyType, double F1, double F2, int PeriodicRigidCombType, double Td) GetModalComb_1(this cCaseResponseSpectrum obj, string Name) {
