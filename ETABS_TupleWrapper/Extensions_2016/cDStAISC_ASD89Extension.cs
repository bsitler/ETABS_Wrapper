...
namespace ETABS2016
{
    ...
    {
		public static (double Value, bool ProgDet) GetOverwrite(this cDStAISC_ASD89 obj, string Name, int Item) {
			double Value;
		...
		public static double GetPreference(this cDStAISC_ASD89 obj, int Item) {
			double Value;
			Value = default(double);
